...
import { SignupInput } from "@anuragsngh26/medium";
...
export const Auth = ({ type }: { type: "signup" | "signin" }) => {
    ...
    async function sendRequest() {
        ...
        // }
        try {
      // send correct payload based on auth type
      const payload =
        type === "signup"
          ? postInputs
          : {
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    {type === "signup" ? <LabelledInput label="Name" placeholder="Anurag Singh..." onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
                    }} /> : null}
                    <LabelledInput label="Username" placeholder="anurag@gmail.com" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
